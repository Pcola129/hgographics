...
static const float 	BORDER_TILE					= 0.45f;
...
static const float GB_CAM_MAX = 335.0f;
...
static const float GB_OPACITY_NEAR = 0.99f; // Transparency when camera is near
...
static const float BORDER_LIGHT_REMOVAL_FACTOR = 0.99f; // How much of the light calculations that are removed from the borders. 1.0f is no light
